...
| ------------- | ------------- | ------------- | ------------- | ------------- | ------------- | ------------- |
| ASUS | [ASUS ROG Strix Z890-I Gaming WIFI](https://rog.asus.com/motherboards/rog-strix/rog-strix-z890-i-gaming-wifi/) | 2201 | v2.0.18 | | HSI:1 | tba |
| NovaCustom | [V54 (Intel)](https://novacustom.com/product/v54-series/) | 1.0.0 | v2.0.18 | Based on coreboot. | HSI:3 | tba |
